...
CUDA_VISIBLE_DEVICES=0 torchrun --master_port=7777 --nproc_per_node=1 train.py -c configs/deim_dfine/dfine_hgnetv2_x_wholebody28.yml --use-amp --seed=0 &> log.txt 2>&1 &
