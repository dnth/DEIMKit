...
class AbstractModel(ABC):
    ...
    def __init__(
        ...
        *,
        ...
        keypoint_score_th: Optional[float] = 0.25,
        ...
        self._keypoint_score_th = keypoint_score_th
...
class DEIM(AbstractModel):
    def __init__(
        ...
        *,
        runtime: Optional[str] = 'onnx',
        model_path: Optional[str] = 'deim_hgnetv2_x_wholebody29_ft_1250query_n_batch.onnx',
        obj_class_score_th: Optional[float] = 0.35,
        attr_class_score_th: Optional[float] = 0.70,
        keypoint_score_th: Optional[float] = 0.35,
        ...
        keypoint_score_th: Optional[float]
        ...
        super().__init__(
            ...
            keypoint_score_th=keypoint_score_th,
            providers=providers,
        )
    ...
    def _postprocess(
        ...
        box_score_threshold: float = min([self._obj_class_score_th, self._attr_class_score_th, self._keypoint_score_th])
            ...
            if len(boxes_keep) > 0:
                ...
                result_boxes = [
                    box for box in result_boxes \
                        if (box.classid in [0,5,6,7,16,17,18,19,20,23,24,25,27,28] and box.score >= self._obj_class_score_th) or box.classid not in [0,5,6,7,16,17,18,19,20,23,24,25,27,28]
                ]
                # Attribute filter
                result_boxes = [
                    box for box in result_boxes \
                ...
                result_boxes = [
                    box for box in result_boxes \
                        if (box.classid in [21,22,26] and box.score >= self._keypoint_score_th) or box.classid not in [21,22,26]
                ]
...
def main():
    ...
    parser.add_argument(
        ...
        '--model',
        type=str,
        default='deim_hgnetv2_x_wholebody29_ft_1250query_n_batch.onnx',
    ...
    keypoint_score_threshold: float = args.keypoint_score_threshold
