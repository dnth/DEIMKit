...
class Config(YAMLConfig):
    ...
    def from_model_name(cls, model_name, **kwargs):
        ...
        possible_paths = [
            ...
            pkg_resources.resource_filename('deim_wrapper', f'configs/{model_name}_coco.yml'),
            pkg_resources.resource_filename('deim_wrapper', f'configs/deim_dfine/{model_name}_coco.yml'),
